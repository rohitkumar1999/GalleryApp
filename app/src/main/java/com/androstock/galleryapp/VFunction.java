...
public class VFunction {
    ...
    public static String getCount(Context c, String album_name)
    {
        ...
        Cursor cursorExternal = c.getContentResolver().query(uriExternal, projection, "bucket_display_name = \""+album_name+"\"",null, MediaStore.Images.ImageColumns.DATE_TAKEN + " DESC");
        Cursor cursorInternal = c.getContentResolver().query(uriInternal, projection, "bucket_display_name = \""+album_name+"\"",null,MediaStore.Images.ImageColumns.DATE_TAKEN + " DESC" );
